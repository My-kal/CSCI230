...
//        public static void main(String[] args) {
            ...
            SinglyLinkedList var2 = new SinglyLinkedList();

            int var3;
            for(var3 = 0; var3 < 5; ++var3) {
                var2.add((Comparable)(new Integer(var3 * 2)));
                var1.add(new Integer(var3 * 2));
            }

            System.out.printf("ll size = %d\n", new Object[]{Integer.valueOf(var2.size())});
            System.out.printf("al size = %d\n", new Object[]{Integer.valueOf(var1.size())});

            for(var3 = 0; var3 < var2.size(); ++var3) {
                System.out.printf("(%d,%d)\n", new Object[]{var2.get(var3), var1.get(var3)});
            }
